var QR = (function () {
  ...
  var api = {
    ...
    draw: function (string, canvas, context, cavW, cavH, returnTemp, ecc) {
        ...
        if (returnTemp) {
          wx.canvasToTempFilePath({
            ...
            success: function (res) {
              returnTemp(res.tempFilePath);
            },
            fail: function (res) {
              console.exception("canvas to temp image error!")
            }
          }, context);
        }
      }
      ...
      ctx.fill();
      ctx.draw(false, canvasToTempImage)
    }
  }
  module.exports = {
    qrApi: api
